export const puzzleTitleWorkflows = [
  ...
  },
  {
    ...
    "title": "🧩subworkflow - aws ssm restart linux service on ec2",
    "description": "Subworkflow to restart a service on a Linux EC2 instance via SSM Run Command and verify it is active.\n\nParameters:\n\ninstanceId: (Required) EC2 instance ID\nserviceName: (Required) service name (e.g. nginx, httpd, tomcat)\nawsRegion: (Required) AWS region\ndynatraceawsconnection: (Required) Dynatrace AWS OIDC connection name",
    "ownerType": "USER",
    "isPrivate": false,
    "schemaVersion": 4,
    "trigger": {},
