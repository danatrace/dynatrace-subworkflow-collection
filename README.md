...
| [subworkflow-aws-ssm-run-powershell-script-on-windows-ec2-and-wait.workflow.json](subworkflow-aws-ssm-run-powershell-script-on-windows-ec2-and-wait.workflow.json) | aws ssm run powershell script on windows ec2 and wait | Run a custom PowerShell script on Windows EC2 and wait for terminal execution status. |
| [subworkflow-aws-ssm-run-shell-script-on-linux-ec2-and-wait.workflow.json](subworkflow-aws-ssm-run-shell-script-on-linux-ec2-and-wait.workflow.json) | aws ssm run shell script on linux ec2 and wait | Run a custom shell script on Linux EC2 and wait for terminal execution status. |
